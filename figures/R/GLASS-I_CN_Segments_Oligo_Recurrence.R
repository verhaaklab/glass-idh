# GLASS-I: CN Segments Oligodendrogliomas Recurrence
...
mean_scores <- process_segments("~/gistic_circos_input_codel_recurrence.csv")                       ## created with prepare_gistic_input.R
