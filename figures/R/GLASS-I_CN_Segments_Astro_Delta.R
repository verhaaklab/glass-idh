# GLASS-I: CN Segments Astrocytomas Delta Recurrence - Primary
...
mean_scores_primary <- process_segments("~/gistic_circos_input_noncodel_primary.csv")                          ## created with prepare_gistic_input.R
mean_scores_recurrent <- process_segments("~/gistic_circos_input_noncodel_recurrence.csv")                     ## created with prepare_gistic_input.R
