#################################################################################################################
# Content: Multivariable stepwise-backward Cox PH models at primary surgery
...
# Multivariable overall survival analysis of patients with IDH-mutant oligodendroglioma
