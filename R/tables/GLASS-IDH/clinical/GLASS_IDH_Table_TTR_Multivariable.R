#################################################################################################################
# Content: Multivariable time-to-recurrence survival stepwise-backward Cox PH models
...
# Multivariable time-to-recurrence survival analysis of patients with IDH-mutant astrocytomas
...
# Multivariable time-to-recurrence survival analysis of patients with IDH-mutant oligodendrogliomas
