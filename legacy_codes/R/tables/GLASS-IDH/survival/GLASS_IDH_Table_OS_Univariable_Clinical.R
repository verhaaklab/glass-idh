#################################################################################################################
# Content: Univariable overall survival Cox PH models of clinical variables
...
cox.zph(coxph(Surv(os_time, os_status) ~ grade, data = all.oligos)) ## PH assumption violated
