# GLASS-I: Univariable Time To Recurrence Molecular Parameters
...
summary(coxph(Surv(ttr_time, ttr_status) ~ PI3K, data = all.oligos ), conf.int=0.9)
cox.zph(coxph(Surv(ttr_time, ttr_status) ~ PI3K, data = all.oligos)) 
survfit(Surv(ttr_time, ttr_status) ~ PI3K, data = all.oligos )

# summary(coxph(Surv(ttr_time, ttr_status) ~ CDKN2AB, data = all.oligos ), conf.int=0.9) ## all non-HD

summary(coxph(Surv(ttr_time, ttr_status) ~ Any_Amplification, data = all.oligos ), conf.int=0.9)
cox.zph(coxph(Surv(ttr_time, ttr_status) ~ Any_Amplification, data = all.oligos))
survfit(Surv(ttr_time, ttr_status) ~ Any_Amplification, data = all.oligos)
...
summary(coxph(Surv(ttr_time, ttr_status) ~ PI3K, data = all.astros ), conf.int=0.9)
cox.zph(coxph(Surv(ttr_time, ttr_status) ~ PI3K, data = all.astros))
survfit(Surv(ttr_time, ttr_status) ~ PI3K, data = all.astros )
...
summary(coxph(Surv(ttr_time, ttr_status) ~ Any_Amplification, data = all.astros ), conf.int=0.9)
cox.zph(coxph(Surv(ttr_time, ttr_status) ~ Any_Amplification, data = all.astros)) 
survfit(Surv(ttr_time, ttr_status) ~ Any_Amplification, data = all.astros)
